...
![exploit result](./images/2025-11-04-16-32-37-image.png)

Results is nice, we find /spip and /images. Let's take a look at these two. 

![exploit result](./images/2025-11-04-16-40-14-image.png)

Not much more information. Let's view the page source.

![exploit result](./images/2025-11-04-16-41-01-image.png)

Nothing interesting here. Let's take a look at /images

![exploit result](./images/2025-11-04-16-41-50-image.png)
...
![exploit result](./images/2025-11-04-16-57-08-image.png)

We find it. Let's use the first one.

![exploit result](./images/2025-11-04-16-58-11-image.png)

Show options will show all the required infos. Let's set the LHOST, RHOSTS and the payload. We need a payload here.

![exploit result](./images/2025-11-04-17-02-46-image.png)

There are many payloads here, so we just use 3 here, a more generic payload.

![exploit result](./images/2025-11-04-18-47-13-image.png)

![exploit result](./images/2025-11-04-18-48-11-image.png)

We successfully open a session after exploiting the target.

![exploit result](./images/2025-11-04-18-52-11-image.png)
...
![exploit result](./images/2025-11-04-18-53-06-image.png)

![exploit result](./images/2025-11-04-18-53-32-image.png)
...
![exploit result](./images/2025-11-04-18-56-13-image.png)
...
![exploit result](./images/2025-11-04-18-59-52-image.png)
...
![exploit result](./images/2025-11-04-22-39-02-image.png)

We don't know the password of think, so we need to find another way. Let's first check the file that is running as root. 

![exploit result](./images/2025-11-04-22-42-15-image.png)

There is a lot. 

![exploit result](./images/2025-11-04-22-58-11-image.png)

Run_container has root access. 

![exploit result](./images/2025-11-04-23-00-00-image.png)

This is our target. run_container has root access and it will finally run the file in /opt.

Proceed to /opt.

![exploit result](./images/2025-11-04-23-04-23-image.png)

We don't have write access in /opt

The hint tells us to look at Apparmor. Let's take a look.

![exploit result](./images/2025-11-04-23-05-29-image.png)

Apparmor is running. And we are currently running in ash shell.

![exploit result](./images/2025-11-04-23-06-34-image.png)

Then let's look at the content of apparmor file.

![exploit result](./images/2025-11-04-23-09-07-image.png)

![exploit result](./images/2025-11-04-23-09-18-image.png)
...
![exploit result](./images/2025-11-04-23-12-58-image.png)

![exploit result](./images/2025-11-04-23-13-12-image.png)

We find it! We have write access at /dev/shm.

Let's continue.

![exploit result](./images/2025-11-04-23-14-15-image.png)

Now we have a bash that has write access, and it is not limited by ash.

![exploit result](./images/2025-11-04-23-24-00-image.png)
...
![exploit result](./images/2025-11-04-23-24-10-image.png)

![exploit result](./images/2025-11-04-23-25-26-image.png)

![exploit result](./images/2025-11-04-23-25-38-image.png)
